...
def inject_text_conversation(session_id, textMsg):
    url = 'https://web-eduvives.cloud.okteto.net:5005/conversations/' + session_id + '/trigger_intent?token=DataVisualizationInLinguisticsSecretToken&include_events=NONE&output_channel=socketio'
    json_msg = {
